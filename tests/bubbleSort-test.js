...
//     expect(bubbleSort(array)).to.deep.equal([1,2,3,4,5,6])
//   })
//
//   it('should also be able to sort letter arrays', () =>{
//     const array = ['a','s','z','x','c'];
//     expect(bubbleSort(array)).to.deep.equal(['a','c','s','x','z'])
//   })
//
//   it('should be able to sort negative numbers', () => {
//     const array = [-3, -1, -7, -5, -4];
//     expect(bubbleSort(array)).to.deep.equal([-7,-5,-4,-3,-1])
//   })
//
...
//   expect(bubbleSort(array)).to.deep.equal(copyArray.sort(function(a,b){
//     return a - b
//   }))
//   })
//
